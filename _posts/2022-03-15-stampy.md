...
layout: post
title: Stampy UI
description: Figma Prototype & Identity Design
...
Edited to add: We had a soft launch for the [alpha version](http://www.ui.stampy.ai) in July. I also wrote about working on their [semantic search](http://localhost:4000/2022/07/05/use.html) and identifying [duplicate questions](http://localhost:4000/2022/06/14/sbert.html).
